...
```{r standard normal, echo=FALSE, warning=FALSE, fig.height=4.5}
...
```{r standard normal cdf, echo=FALSE, warning=FALSE, fig.height=4.5}
...
- Note: `lower.tail=TRUE` if calculating area to LEFT of value $k$, `=FALSE` if to the RIGHT
...
### Finding Z-Score Preobabilities with *R* II

- Probability a student gets between a 65 and 85:
```{r, zscore3}
pnorm(85, mean=75, sd=10, lower.tail=TRUE)-pnorm(65, mean=75, sd=10, lower.tail=TRUE)
```
