...
$$\sigma^2 = \frac{\displaystyle\sum^N_{i=1} (x_i-\mu)^2}{N}	$$
...
$$\sigma=\sqrt{\sigma^2}=\sqrt{\frac{\displaystyle\sum^N_{i=1} (x_i-\mu)^2}{N}	}$$
...
$$s^2 = \frac{\displaystyle\sum^n_{i=1} (x_i-\bar{x})^2}{n-1}	$$
...
$$s=\sqrt{s^2}=\sqrt{\frac{\displaystyle\sum^n_{i=1} (x_i-\bar{x})^2}{n-1}	}$$
