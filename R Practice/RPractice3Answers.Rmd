...
$\hat{beta_3}$ has a standard error of 0.52, which means it has a $t$-statistic of 2.355 and $p$-value of 0.0185, so it is statistically significant. 
